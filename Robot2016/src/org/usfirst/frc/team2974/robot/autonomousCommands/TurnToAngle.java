...
/**
 * This class is used to turn the robot from its current angle (START_ANGLE) to its GOAL_ANGLE it does this by turn form
 * a point.
 */
public class TurnToAngle extends Command {
	...
	public TurnToAngle(double angle) {
		...
		this.ANGLES_TO_TURN =
			TURN_CLOCKWISE ? Math.abs(GOAL_ANGLE - START_YAW_ANGLE) : 360 - Math.abs(GOAL_ANGLE - START_YAW_ANGLE);
	}
