 ...
 * problem is when the data returned is an object and you want to record the data from
 * that class, i don't know how to retrieve the data that returned from a method called, 
 * also have to make the program fast enought that it get the method calls in time 
 * (might be able to work with MethodCallDebugger if we manage to make it work)
 */
